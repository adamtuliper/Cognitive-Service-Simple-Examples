...
namespace CognitiveFunctions
{
    ...
    public class LUISMakerShowClient
    {
        public static async Task<MakerLUIS> ParseUserInput(string strInput)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                string uri = "https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/61f8418b-ec4a-4471-9558-82cbab3d96d5?subscription-key=240c5dfd3a5e432e96f613e9c5a83136&verbose=true&q=" + strEscaped;
    ...
    public class Luis
    {
        public async void Process()
        {
            ...
            MakerLUIS mkLuis = await LUISMakerShowClient.ParseUserInput("This is the user input");
            string strRet = string.Empty;
            string strTech = "This is the user input";
